...
import { APP_SECTION_LABELS } from "../constants.js";

export default function AppSectionOrderCard({ sections, onMove, onToggle }) {
    ...
    <div className="card bg-base-100 shadow-xl">
      <div className="card-body space-y-4">
        <div className="flex flex-col gap-1">
          <h2 className="card-title text-2xl">Ordem das secoes</h2>
          <p className="text-base-content/70">Defina a sequencia como cada bloco aparece para os utilizadores.</p>
        </div>
          ...
          {sections.map((section, index) => (
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-semibold">{APP_SECTION_LABELS[section.type] ?? section.type}</p>
              ...
              <div className="flex flex-wrap items-center gap-3">
                {typeof onToggle === "function" && (
                  <label className="label cursor-pointer gap-3">
                    <span className="text-sm text-base-content/70">{section.active ? "Visivel" : "Oculta"}</span>
                    <input
                      type="checkbox"
...
AppSectionOrderCard.propTypes = {
  sections: PropTypes.arrayOf(PropTypes.object),
  onMove: PropTypes.func,
  onToggle: PropTypes.func,
};

AppSectionOrderCard.defaultProps = {
  sections: [],
  onMove: null,
  onToggle: null,
};
